...
from routers.client_apis_clickhouse.fetch_sensor_data import router as fetch_sensor_data
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000","https://datasnake.io"],  # Replace with your frontend's URL
